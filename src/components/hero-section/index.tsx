...
export function HeroSection() {
  return (
    <section className="container flex relative items-center justify-center mt-16">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 min-h-[20rem] md:h-[36rem] items-center">
        ...
        <div className="relative hidden h-[20rem] md:h-full order-first md:order-last items-center justify-center md:flex lg:flex">
          <Image
